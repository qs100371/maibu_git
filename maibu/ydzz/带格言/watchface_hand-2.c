...
/*显示步数文本图层*/
#define SYSINFO_STEP_ORIGIN_X		30
#define SYSINFO_STEP_ORIGIN_Y		80
#define SYSINFO_STEP_SIZE_H		16		
#define SYSINFO_STEP_SIZE_W		68

const unsigned char motto[12][50] = 
{"希望是穷人的面包","天才出自勤奋","一分耕耘,一分收获","奋发有为,时不我待","百学须先立志","不塞不流,不止不行","高山仰止,景行行止"};
...
char str[20] = "";
	...
	if (0 == maibu_get_sport_data(&data, 0))
	{
		...
		LayerText lt_step = {str, frame_step, GAlignCenter, U_ASCII_ARIAL_12,0};
